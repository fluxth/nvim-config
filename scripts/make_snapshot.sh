...
log "GitHub" "creating github release from tag ${NEW_TAG}"

gh release -R fluxth/nvim-config create "$NEW_TAG" --notes "Changes since the \`$LATEST_TAG\` release:
https://github.com/fluxth/nvim-config/compare/$LATEST_TAG..$NEW_TAG"
